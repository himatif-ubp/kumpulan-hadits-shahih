...
import com.ubp.student.kumpulanhadis.adapter.BabGridAdapter;
...
public class ListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BabModel2 babModel2 = new BabModel2(1, 1, 1, "asdasdasd");
        models.add(babModel2);
        babModel2 = new BabModel2(1, 1, 1, "asdasdasd asdasdsa");
        models.add(babModel2);
